...
const MovieItem = ({ movie, grid, id, name, price, desc, info, imageURL}) => { // makes the card for displaying the data
  ...
  return (
    ...
    <Card cardClass={grid ? `${styles.grid}` : `${styles.list}`}>
      ...
      <div className={styles.content}>
        ...
        {/* <button className="--btn --btn-danger" onClick={() => addToCart(movie)}>Add To Cart</button> */}
